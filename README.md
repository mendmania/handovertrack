...
locally. Physical camera/native-upload validation remains open. Task 05 deployment preparation is implemented; the apex DNS record is configured, while SSH image transfer and owner-authenticated import are pending and nothing is deployed.
