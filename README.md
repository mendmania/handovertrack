...
locally. Physical camera/native-upload validation remains open. Task 05 deployment preparation is implemented; the apex DNS record is configured, the SSH image transfer is complete and verified, while owner-authenticated import remains pending and nothing is deployed.
