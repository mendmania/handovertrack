// Historical compatibility fixture: exact protocol body from live-source
// ba2ecc8d8040eda6e5d57bf73d6d17e90a4d2337, apps/mobile/src/sync/protocol.ts.
// Only the contracts import is relocated for this test harness. Test only. Do not relax this to suggest the retained v4 phone accepts v5 feeds.
import { assertCompleteSnapshot, type Assignment, type Scope, type SyncBootstrap, type SyncPage } from '../../packages/contracts/src/index';
